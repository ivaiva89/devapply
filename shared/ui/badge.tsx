  ...
  "group/badge inline-flex h-5 w-fit shrink-0 items-center justify-center gap-1 overflow-hidden rounded-4xl border border-transparent px-2 py-0.5 text-xs font-medium whitespace-nowrap transition-all focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-primary/50 has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&>svg]:pointer-events-none [&>svg]:size-3!",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-secondary text-text [a]:hover:bg-secondary/80",
        destructive:
          "bg-danger/10 text-destructive focus-visible:ring-destructive/20 dark:bg-danger/20 dark:focus-visible:ring-destructive/40 [a]:hover:bg-danger/20",
        outline:
          "border-border text-text [a]:hover:bg-muted [a]:hover:text-text-3",
        ghost:
          "hover:bg-muted hover:text-text-3 dark:hover:bg-muted/50",
