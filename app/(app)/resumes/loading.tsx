      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)]">
        <div className="rounded-3xl border border-border/70 bg-surface p-6 shadow-sm">
          <div className="space-y-3">
            ...
            <div className="h-12 animate-pulse rounded-2xl bg-surface-1/80" />
            <div className="h-10 w-36 animate-pulse rounded-full bg-surface-1/80" />
          </div>
        </div>
        <div className="space-y-4">
          {Array.from({ length: 2 }).map((_, index) => (
            ...
            >
              <div className="h-6 w-40 animate-pulse rounded bg-surface-1/80" />
              <div className="mt-4 h-28 animate-pulse rounded-2xl bg-surface-1/80" />
            </div>
          ))}
        </div>
      </div>
